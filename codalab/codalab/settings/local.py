...
class Dev(DevBase):
    ...
    AZURE_ACCOUNT_KEY = 'jlq9USDcGXbjsTfRz2QzkMDeqL0tplXSy2QxIqI7H9yacHWuHjKw8EB8qqUOylfpKS/PS/avMkFRUoS7GD3A4g=='
    ...
    # Service Bus
    SBS_NAMESPACE = 'codalabsb'
    SBS_ISSUER = 'owner'
    SBS_ACCOUNT_KEY = 'AmlMvA1U4H+OsrEWi9hJa/Z6dafT4LRBwueakOcIniM='
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'MySQL_DevDB',            # Name of the database.
            'USER': 'root',
            'PASSWORD': 'codalab',
